    ...
    >
      ...
      >
        <View style={[styles.container, { backgroundColor: theme.neutralWhite }]}>
          <Text style={[styles.title, { color: theme.textDark }]}>Welcome back, Please Login</Text>
          <View style={styles.form}>
            ...
            <View style={styles.loginContainer}>
              <Text style={[styles.loginText, { color: theme.textDark }]}>Don't have an account yet?</Text>
              <TouchableOpacity onPress={() => router.push('/(auth)/Signup')}>
                <Text style={[styles.loginLink, { color: theme.primary }]}>Sign up</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
